...
const AdminLogin = () => {
	...
	return (
		<Page title="Login">
			<div className="card-compact glassy rounded-3xl lg:card-side bg-base-300 shadow-xl flex items-center justify-center p-10 pb-16 w-11/12 sm:w-5/6 md:w-1/2 mx-auto mt-48">
